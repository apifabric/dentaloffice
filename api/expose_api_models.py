...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.Dentist, method_decorators= method_decorators)
    api.expose_object(database.models.Patient, method_decorators= method_decorators)
    api.expose_object(database.models.AppointmentTreatment, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.PatientInsurance, method_decorators= method_decorators)
