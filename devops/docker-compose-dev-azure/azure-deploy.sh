...
resourcename="dentaloffice"  # lower case, only
resourcegroup="dentaloffice_rg"
...
# git clone https://github.com/apilogicserver/dentaloffice.git
# cd dentaloffice
...
az group create --name dentaloffice_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group dentaloffice_rg --sku S1 --is-linux
az container create --resource-group dentaloffice_rg --name dentaloffice --image apilogicserver/dentaloffice:latest --dns-name-label dentaloffice --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//dentaloffice.westus.azurecontainer.io:5656'
