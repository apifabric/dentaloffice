...
@Component({
  selector: 'AppointmentTreatment-home',
  templateUrl: './AppointmentTreatment-home.component.html',
  styleUrls: ['./AppointmentTreatment-home.component.scss']
})
export class AppointmentTreatmentHomeComponent implements AfterViewInit {
