...
@Component({
  selector: 'PatientInsurance-home',
  templateUrl: './PatientInsurance-home.component.html',
  styleUrls: ['./PatientInsurance-home.component.scss']
})
export class PatientInsuranceHomeComponent implements AfterViewInit {
